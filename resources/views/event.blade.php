<x-layouts.app>
    ...
    <section class="py-5">
        <div class="container event-future-section">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    <h2 class="fw-bold mb-3" style="color: #0C008F;">Événements à la Une</h2>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="event-card bg-white rounded-4 shadow-sm overflow-hidden border-0 h-100">
                        <div class="position-relative">
                            <img src="{{ asset('img/ChatGPT_Image.png') }}" class="card-img-top" style="height: 200px; object-fit: cover;" alt="Concert Jazz">
                            <div class="position-absolute top-0 end-0 m-3">
                                <span class="badge text-white px-3 py-2" style="background: linear-gradient(135deg, #0C008F, #0033FF);">
                                    <i class="fas fa-music me-1"></i>Concert
                                </span>
                            </div>
                            <div class="position-absolute bottom-0 start-0 m-3">
                                <span class="badge bg-white text-dark px-3 py-2 fw-bold">
                                    <i class="fas fa-calendar me-1"></i>25 Déc
                                </span>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-2">Summer Game 2025</h5>
                            <p class="text-muted mb-3">
                                <i class="fas fa-map-marker-alt me-2" style="color: #0033FF;"></i>
                                Salle Pleyel, Paris
                            </p>
                            <p class="card-text text-muted small mb-3">
                                Une soirée exceptionnelle avec les plus grands noms du jazz international. Venez découvrir des mélodies envoûtantes...
                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="h5 fw-bold" style="color: #0C008F;">89€</span>
                                    <small class="text-muted text-decoration-line-through ms-2">120€</small>
                                </div>
