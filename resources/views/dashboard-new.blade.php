    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-primary fw-bold">Bonjour, {{ Auth::user()->name ?? 'Utilisateur' }} !</h1>
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-3 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div class="mb-3">
                        <i class="fas fa-ticket-alt fa-3x" style="color: #06B6D4;"></i>
                    </div>
                    <h3 class="fw-bold" style="color: #06B6D4;">3</h3>
        ...
        <div class="col-md-3 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div class="mb-3">
                        <i class="fas fa-heart fa-3x" style="color: #FFD400;"></i>
                    </div>
                    <h3 class="fw-bold" style="color: #FFD400;">8</h3>
        ...
        <div class="col-md-3 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <div class="mb-3">
                        <i class="fas fa-euro-sign fa-3x" style="color: #10B981;"></i>
                    </div>
                    <h3 class="fw-bold" style="color: #10B981;">245€</h3>
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="#" class="btn btn-outline-primary w-100 py-3 text-start">
                                ...
                                <div>
                                    ...
                                    <small class="d-block text-muted">Trouvez votre prochain événement</small>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
